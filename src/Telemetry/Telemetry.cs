...
namespace Microsoft.Azure.WebJobs.Extensions.MySql.Telemetry
{
    public sealed class Telemetry
    {
        ...
        private const string EventsNamespace = "azure-functions-mysql-bindings";
        ...
        /// </summary>
        public const string TelemetryOptoutEnvVar = "AZUREFUNCTIONS_MYSQLBINDINGS_TELEMETRY_OPTOUT";
        /// <summary>
        /// The app setting used for opting out of telemetry
        /// </summary>
        public const string TelemetryOptoutSetting = "AzureFunctionsMySqlBindingsTelemetryOptOut";

        public const string WelcomeMessage = @"Azure MySQL binding for Azure Functions
-----------------------------------------------
Azure Functions MySQL Binding Extension Telemetry
-----------------------------------------------
...
";
        ...
        private static string ExtractErrorCode(Exception ex)
        {
            ...
            {
                return (ex as MySqlException).Number.ToString(CultureInfo.InvariantCulture);
            }
            return string.Empty;
        }
    }
    ...
    internal class ServerProperties
    {
        ...
        internal string Version_Comment;
    }
}
