...
namespace Microsoft.Azure.WebJobs.Extensions.MySql.Tests.Integration
{
    public class IntegrationTestBase : IDisposable
    {
        ...
        private void SetupDatabaseObjects()
        {
            ...
            this.DbConnectionString = Environment.GetEnvironmentVariable("MySqlConnectionString");
            this.Connection = new MySqlConnection(this.DbConnectionString);
        ...
        public void StartFunctionHost(string functionName, SupportedLanguages language, bool useTestFolder = false, DataReceivedEventHandler customOutputHandler = null, IDictionary<string, string> environmentVariables = null)
        {
            ...
            if (language == SupportedLanguages.Java)
            {
                ...
                string projectName = useTestFolder ? "azure-functions-java-library-mysql-tests" : "azure-functions-java-library-mysql-samples";
