...
namespace Microsoft.Azure.WebJobs.Extensions.MySql.Tests.Integration
{
    ...
    public class MySqlInputBindingIntegrationTests : IntegrationTestBase
    {
        ...
        public async void GetProductsColumnTypesSerializationAsyncEnumerableTest(string culture, SupportedLanguages lang)
        {
            ...
            ProductColumnTypes[] expectedResponse = Utils.JsonDeserializeObject<ProductColumnTypes[]>(/*lang=json,strict*/ "[{\"ProductId\":999,\"BigIntType\":999,\"BitType\":1,\"DecimalType\":1.2345,\"NumericType\":1.2345,\"SmallIntType\":1,\"TinyIntType\":1,\"FloatType\":0.1,\"RealType\":0.1,\"DateType\":\"2024-08-10T00:00:00.000Z\",\"DatetimeType\":\"2024-08-10T12:40:15.000Z\",\"TimeType\":\"12:40:15\",\"CharType\":\"test\",\"VarcharType\":\"test\",\"NcharType\":\"test\",\"NvarcharType\":\"test\",\"BinaryType\":\"test\",\"VarbinaryType\":\"test\"}]");
        ...
        public async void GetProductsColumnTypesSerializationTest(SupportedLanguages lang)
        {
            ...
            ProductColumnTypes[] expectedResponse = Utils.JsonDeserializeObject<ProductColumnTypes[]>(/*lang=json,strict*/ "[{\"ProductId\":999,\"BigIntType\":999,\"BitType\":1,\"DecimalType\":1.2345,\"NumericType\":1.2345,\"SmallIntType\":1,\"TinyIntType\":1,\"FloatType\":0.1,\"RealType\":0.1,\"DateType\":\"2024-08-10T00:00:00.000Z\",\"DatetimeType\":\"2024-08-10 12:40:15\",\"TimeType\":\"12:40:15\",\"CharType\":\"test\",\"VarcharType\":\"test\",\"NcharType\":\"test\",\"NvarcharType\":\"test\",\"BinaryType\":\"test\",\"VarbinaryType\":\"test\"}]");
            string actualResponse = await response.Content.ReadAsStringAsync();
            ProductColumnTypes[] actualProductResponse = Utils.JsonDeserializeObject<ProductColumnTypes[]>(actualResponse);
            Console.WriteLine("Array size: " + $"{actualProductResponse.Length} {expectedResponse.Length}");
            Console.WriteLine("Debug Values 1: " + $"{expectedResponse[0] == actualProductResponse[0]} {expectedResponse[1] == actualProductResponse[1]} {expectedResponse[2] == actualProductResponse[2]} {expectedResponse[3] == actualProductResponse[3]} {expectedResponse[4] == actualProductResponse[4]} {expectedResponse[5] == actualProductResponse[5]} {expectedResponse[6] == actualProductResponse[6]} {expectedResponse[7] == actualProductResponse[7]} {expectedResponse[8] == actualProductResponse[8]} {expectedResponse[9] == actualProductResponse[9]} {expectedResponse[10] == actualProductResponse[10]} {expectedResponse[11] == actualProductResponse[11]} {expectedResponse[12] == actualProductResponse[12]} {expectedResponse[13] == actualProductResponse[13]} {expectedResponse[14] == actualProductResponse[14]} {expectedResponse[15] == actualProductResponse[15]} {expectedResponse[16].Equals(actualProductResponse[16])} {expectedResponse[17].Equals(actualProductResponse[17])}");
