...
namespace Microsoft.Azure.WebJobs.Extensions.MySql.Tests.Unit
{
    ...
    {
        private const string TestEnvVar = "AzureFunctionsMySqlBindingsTestEnvVar";
        private const string TestConfigSetting = "AzureFunctionsMySqlBindingsTestConfigSetting";
